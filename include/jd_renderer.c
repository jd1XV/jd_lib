...
void jd_2DColorTextureRect(jd_Texture t, jd_V2F position, jd_V2F size, f32 corner_rad, f32 softness, f32 thickness, jd_V4F color, jd_V4F clip) {
    f32 x = position.x;
    f32 y = position.y;
    f32 z = 0;
...
void jd_2DTextureRect(jd_Texture t, jd_V2F position, jd_V2F size, f32 corner_rad, f32 softness, f32 thickness, jd_V4F clip) {
    ...
    jd_2DColorTextureRect(t, position, size, corner_rad, softness, thickness, color, clip);
}

jd_ForceInline u32 jd_GlyphTextureID(jd_Font* font, u16 point_size, u32 codepoint) {
...
jd_Texture jd_GlyphGetTexture(jd_Font* font, u32 codepoint, u16 point_size) {
    jd_Texture t = {0};
