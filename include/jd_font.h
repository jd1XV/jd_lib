...
jd_ExportFn jd_Bitmap jd_FontGetGlyphBitmap(jd_Arena* arena, jd_Font2* font, u32 codepoint, u32 size);
...
jd_ExportFn jd_Font2* jd_OSBaseFont();
jd_ExportFn jd_Font2* jd_OSSymbolFont();
